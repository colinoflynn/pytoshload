...
SET CC_OPT=-$ -DTMP86FM48 -DBUFFER_SIZE=0x40 -DRW_UNALIGNED -w1 -c -l -XS -I FLASH -I SRC -I SYSTEM -I SYSTEM\TLCS_870
...
IF EXIST RAM_Image.h20 COPY RAM_Image.h20 ..\RamImage\C_FEE64_RAM40_ROM8000_TLCS870_86XX48.hex
