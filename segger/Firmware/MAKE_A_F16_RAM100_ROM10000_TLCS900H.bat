...
SET CC_OPT=-$ -DTMP95FY64 -DBUFFER_SIZE=0x100 -w1 -c -l -XS -I FLASH -I SRC -I SYSTEM -I SYSTEM\TLCS_900_H -DINT_ROMBASEADDR=0x010000
...
IF EXIST RAM_Image.h20 COPY RAM_Image.h20 ..\RamImage\A_F16_RAM100_ROM10000_TLCS900H.hex
