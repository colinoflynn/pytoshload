...
SET CC_OPT=-$ -DTMP86FP24 -DBUFFER_SIZE=0x80 -DRW_UNALIGNED -w1 -c -l -XS -I FLASH -I SRC -I SYSTEM -I SYSTEM\TLCS_870
...
IF EXIST RAM_Image.h20 COPY RAM_Image.h20 ..\RamImage\C_FEE128_RAM40_ROM4000_TLCS870_86XX24.hex
